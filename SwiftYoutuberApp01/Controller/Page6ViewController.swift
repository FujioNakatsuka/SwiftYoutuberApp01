...
class Page6ViewController: UITableViewController,SegementSlideContentScrollViewDelegate {
    ...
    func getData(){
        //リクエストを送る。JSON解析を行う。値が返ってくるので、for文で全て配列に入れる
         var text =  "https://www.googleapis.com/youtube/v3/search?key=AIzaSyAPtvfz4MTceYCpjk8KcO2HOjGEFH0AAOA&q=rocket girls 101&part=snippet&maxResults=19&order=date"
